            ...
            <div class="wraper container-fluid">
                ...
                <div class="row">
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   <td>
                                                    <a href='{{url("/edit/$house->house_No")}}'><button class="btn btn-icon btn-primary m-b-5"> <i class="fa fa-pencil"></i> Edit</button></a> </td>
                                                </tr>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading"><h3 class="panel-title">Edit House Details</h3></div>
                            <div class="panel-body">
                            
                                <form class="form-inline" role="form" action="{{ url('/updatehouse', array($house->house_No))}}" method="POST">
                                     @csrf
                                    <div class="form-group">
                                        <label for="housenumber">House Number</label>
                                        <input type="text" class="form-control" id="housenumber"   value="{{$house->house_No}}" name="house_No">
                                    </div>
                                      
                                    <div class="form-group m-l-10">
                                        <label for="houseamount">House Amount</label>
                                        <input type="text" class="form-control" id="houseamount" value="{{$house->House_Amount}}" name="House_Amount">
                                    </div>
                                     <div class="form-group m-l-10">
                                    ...
                                    <button type="submit" class="btn btn-warning m-l-10">Submit</button>
                                </form>
                            </div> <!-- panel-body -->
                        </div> <!-- panel -->
                    </div> <!-- col -->
                ...
                <a href="{{url('houseform')}}"><button type="submit" class="btn btn-success m-l-10">Back</button></a>
